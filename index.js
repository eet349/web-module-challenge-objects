...
*/
console.log(createMenuItem('Hot Pocket', 2, 'Lunch'));
console.log(createMenuItem('Corn Dog', 1.5, 'Lunch'));
console.log(createMenuItem('Dr. Pepper', 1.75, 'Drink'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
export const burger = {
	...
	price: 18,
	category: 'Lunch',
	discount: function (discStr) {
		if (discStr === 'teacher' || discStr === 'student') {
			return this.price * 0.75;
		} else if (discStr === 'public') {
			return this.price * 0.9;
		} else return this.price;
	},
};

console.log('Price for Teacher: ', burger.discount('teacher'));
console.log('Price for student: ', burger.discount('student'));
console.log('Price for public: ', burger.discount('public'));
///////////////Reviews (MVP)///////////////////
const reviews = [
	{
		name: 'Daniela',
...
reviews.push({
	name: 'Fred',
	rating: 4,
	feedback: 'Friendly staff but a bit overpriced.',
});
console.log(reviews);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
